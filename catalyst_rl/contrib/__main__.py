...
from catalyst_rl.contrib.scripts import find_thresholds
...
try:
    ...
    from catalyst_rl.contrib.scripts import check_index_model, create_index_model
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(
        "catalyst_rl-contrib", formatter_class=RawTextHelpFormatter
    )
