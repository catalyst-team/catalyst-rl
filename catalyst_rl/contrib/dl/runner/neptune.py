...
from catalyst_rl.dl.core import Experiment, Runner
from catalyst_rl.dl.experiment import ConfigExperiment
from catalyst_rl.dl.runner import SupervisedRunner
...
class NeptuneRunner(Runner):
    ...
    Examples:
        Initialize runner::
            ...
            from catalyst_rl_rl.dl import SupervisedNeptuneRunner
        ...
        Pass `monitoring_params` and train model::
            ...
            runner.train(
                ...
                monitoring_params={
                    "init": {
                       "project_qualified_name": "shared/catalyst_rl-integration",
                       "api_token": "ANONYMOUS",  # api key,
                    },
                    "create_experiment": {
                        "name": "catalyst_rl-example", # experiment name
