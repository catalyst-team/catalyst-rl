...
Examples:
    ...
    .. code:: bash
        ...
        $ catalyst_rl-data process-images \\
    ...
    4. **split-dataframe** split your dataset into train/valid folds
     ...
     .. code:: bash
         ...
         $ catalyst_rl-data split-dataframe \\
            --in-csv=./data/dataset_raw.csv \\
    ...
    .. code:: bash
        ...
        $ catalyst_rl-data image2embedding \\
...
from catalyst_rl.data.scripts import (
...
try:
    ...
    from catalyst_rl.data.scripts import text2embedding
...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(
        "catalyst_rl-data", formatter_class=RawTextHelpFormatter
    )
    parser.add_argument(
