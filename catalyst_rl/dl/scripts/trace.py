...
from catalyst_rl.dl import Experiment, utils
from catalyst_rl.dl.utils import trace
from catalyst_rl.utils.tools.typing import Device
...
def main(args, _):
    """
    Main method for `catalyst_rl-dl trace`
    """
