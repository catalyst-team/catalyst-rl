...
from catalyst_rl.utils import args_are_not_none
...
def split_dataframe_on_stratified_folds(
    ...
    Also see :class:`catalyst_rl.data.sampler.BalanceClassSampler`
...
def balance_classes(
    ...
    See also :class:`catalyst_rl.data.sampler.BalanceClassSampler`
